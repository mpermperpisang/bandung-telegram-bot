...
begin
  client = Mysql2::Client.new(:host => "localhost", :username => "root", :password => "bukalapak")
    ...
    File.open('/home/bukalapak/bot/require/helper_cap.rb', 'w+') do |f|
    ...
    line = File.read('/home/bukalapak/bot/require/helper_cap.rb')
    line1 = line.gsub('{"chat_id"=>"', '')
    line2 = line1.gsub("\n", '')
    p @chat_id = line2.gsub('"}', '')

    File.open('/home/bukalapak/bot/require/ruby_cap.rb', 'w+') do |f|
    ...
    line = File.read('/home/bukalapak/bot/require/ruby_cap.rb')
