def new_member(message, bot)
  ...
  unless message.new_chat_members[0].is_bot == true
    ...
    bot.api.send_message(chat_id: @chat_id, text: msg_welcome_member(@member), parse_mode: 'HTML')
...
def left_member(message, bot)
  ...
  unless message.left_chat_member.is_bot == true
    ...
    bot.api.send_message(chat_id: @chat_id, text: msg_left_member(@member), parse_mode: 'HTML')
